...
def authorize_twitter():
    ...
    consumer_key = request.args.get('consumer_key') if request.args.get('consumer_key') else config["consumer_key"]
    consumer_secret = request.args.get('consumer_secret') if request.args.get('consumer_secret') else config["consumer_secret"]
